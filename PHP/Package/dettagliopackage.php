...
END;
		...
		$subPackages=  $conn->query($query) or die("Query fallita: ".mysqli_error($conn));
...
END;
		...
		$classes=  $conn->query($query) or die("Query fallita: ".mysqli_error($conn));
...
END;
		...
		$relpack=  $conn->query($query) or die("Query fallita: ".mysqli_error($conn));
